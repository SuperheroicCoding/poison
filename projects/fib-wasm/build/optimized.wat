(module
 ...
 (data (i32.const 352) "\1a\00\00\00\01\00\00\00\01\00\00\00\1a\00\00\00~\00l\00i\00b\00/\00a\00r\00r\00a\00y\00.\00t\00s")
 (data (i32.const 400) "\04\00\00\00\10\00\00\00\00\00\00\00\10\00\00\00\00\00\00\00\10\00\00\00\00\00\00\00\93\04\00\00\02")
 ...
 (func $~lib/arraybuffer/ArrayBufferView#constructor (; 16 ;) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  i32.const 200
 ...
 (func $projects/fib-wasm/assembly/index/fibRec (; 17 ;) (param $0 i32) (result i32)
  local.get $0
  i32.const 2
  i32.lt_s
  if
 ...
 (func $projects/fib-wasm/assembly/index/fib (; 18 ;) (param $0 i32) (result i32)
  i32.const 0
  global.set $projects/fib-wasm/assembly/index/recCalls
  local.get $0
  call $projects/fib-wasm/assembly/index/fibRec
 ...
 (func $~lib/array/Array<i32>#__set (; 24 ;) (param $0 i32) (param $1 i32) (param $2 i32)
  (local $3 i32)
  local.get $1
  local.get $0
  i32.load offset=12
 ...
 (func $~lib/array/Array<i32>#__get (; 25 ;) (param $0 i32) (param $1 i32) (result i32)
  local.get $1
  local.get $0
  i32.load offset=12
  i32.ge_u
 ...
 (func $projects/fib-wasm/assembly/index/fibRecMem (; 26 ;) (param $0 i32) (result i32)
  (local $1 i32)
 ...
 (func $projects/fib-wasm/assembly/index/fibMem (; 27 ;) (param $0 i32) (result i32)
  (local $1 i32)
  i32.const 0
  global.set $projects/fib-wasm/assembly/index/recCalls
  loop $while-continue|0
