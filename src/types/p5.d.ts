...
declare class p5 {
   ...
   *   @chainable
   */
  colorMode(mode: p5.COLOR_MODE, max?: number): p5
   ...
   *   @chainable
   */
  arc(x: number, y: number, w: number, h: number, start: number, stop: number, mode?: p5.ARC_MODE): p5
   ...
   *   @chainable
   */
  ellipseMode(mode: p5.ELLIPSE_MODE): p5
   ...
   *   @chainable
   */
  strokeCap(cap: p5.STROKE_CAP): p5
   ...
   *   @chainable
   */
  strokeJoin(join: p5.STROKE_JOIN): p5
   ...
   */
  createGraphics(w: number, h: number, renderer?: p5.RENDERER): p5.Graphics
   ...
   */
  blendMode(mode: p5.BLEND_MODE): void
   ...
   *   @chainable
   */
  beginShape(kind?: p5.BEGIN_KIND): p5
   ...
   */
  imageMode(mode: p5.IMAGE_MODE): void
   ...
   *   SOFT_LIGHT, DODGE, BURN, ADD or NORMAL.
   */
  blend(srcImage: p5.Image, sx: number, sy: number, sw: number, sh: number, dx: number, dy: number, dw: number, dh: number, blendMode: p5.BLEND_MODE): void
   ...
   */
  angleMode(mode: p5.ANGLE_MODE): void
   ...
   *   @chainable
   */
  textAlign(horizAlign: p5.HORIZ_ALIGN, vertAlign?: p5.VERT_ALIGN): p5
   ...
   *   @chainable
   */
  textStyle(theStyle: p5.THE_STYLE): p5
